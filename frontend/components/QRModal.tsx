...
export default function QRModal({
    ...
    return (
        ...
        >
            <div className="relative mx-4 w-full max-w-sm animate-fade-in rounded-2xl border border-white/10 bg-black p-6 sm:p-8">
                <button
                    onClick={onClose}
                ...
                <div className="flex flex-col items-center">
                    ...
                    <button
                        ...
                        className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-black transition-opacity active:opacity-80"
                    >
                        Download QR Code
                    </button>
                </div>
